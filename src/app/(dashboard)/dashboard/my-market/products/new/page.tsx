...
import { useMyShop, useCreateMenuItem, useCreateMenuCategory } from '@/hooks/useShops';
import { ArrowLeft, Plus, Loader2 } from 'lucide-react';
import Link from 'next/link';
import toast from 'react-hot-toast';

export default function MyMarketNewProductPage() {
  ...
  async function handleAddCategory() {
    ...
    try {
      await createCategory.mutateAsync({ shopId: restaurant.id, name: newCategoryName.trim() });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push('/dashboard/my-market/products');
    } catch {
  ...
  return (
    <div className="max-w-xl mx-auto space-y-5">
      ...
      <div className="flex items-center gap-3">
        <Link
          href="/dashboard/my-market/products"
