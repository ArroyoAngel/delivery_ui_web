...
import { useShop, useUpdateMenuItemAvailability } from '@/hooks/useShops';
...
export default function ShopMenuPage() {
  ...
  async function saveStockEdit(item: MenuItem) {
    ...
    try {
      await api.patch(`/api/shops/${params.id}/menu/${item.id}`, {
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button
          variant="primary"
          size="sm"
          onClick={() => router.push(`/dashboard/shops/${params.id}/menu/new`)}
        >
          <Plus size={14} />
          Agregar item
        </Button>
