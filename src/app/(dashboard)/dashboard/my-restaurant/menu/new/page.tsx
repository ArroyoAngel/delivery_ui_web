...
import { useMyRestaurant, useCreateMenuItem, useCreateMenuCategory } from '@/hooks/useRestaurants';
import { ArrowLeft, Plus, Loader2 } from 'lucide-react';
import Link from 'next/link';
import toast from 'react-hot-toast';

export default function MyRestaurantNewMenuItemPage() {
  ...
  async function handleAddCategory() {
    ...
    try {
      await createCategory.mutateAsync({ restaurantId: restaurant.id, name: newCategoryName.trim() });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push('/dashboard/my-restaurant/menu');
    } catch {
  ...
  return (
    <div className="max-w-xl mx-auto space-y-5">
      ...
      <div className="flex items-center gap-3">
        <Link
          href="/dashboard/my-restaurant/menu"
